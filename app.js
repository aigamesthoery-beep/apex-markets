...
const MARKET_DATA = {
    TH: {
        ...
        mainSymbol: 'SET:SET',
        indices: [
            { name: 'SET Index', symbol: 'SET:SET', value: '1,428.35', change: '+12.40', pct: '+0.88%', up: true },
...
// News data
const NEWS_DATA = [
    { headline: 'Federal Reserve Signals Potential Rate Cut in Q2 2026 as Inflation Cools', source: 'Reuters', time: '15 min ago', sentiment: 'positive', category: 'usa', tags: ['SPY', 'QQQ', 'TLT'] },
    { headline: 'SET Index Rallies Past 1,400 on Foreign Inflows and Tourism Recovery', source: 'Bangkok Post', time: '32 min ago', sentiment: 'positive', category: 'thailand', tags: ['SET', 'AOT', 'MINT'] },
    { headline: 'NVIDIA Unveils Next-Gen Blackwell Ultra GPUs, Stock Surges 4%', source: 'CNBC', time: '1 hr ago', sentiment: 'positive', category: 'usa', tags: ['NVDA', 'AMD', 'SMCI'] },
    { headline: 'Bitcoin Breaks $105,000 Resistance Level Amid Institutional Buying', source: 'CoinDesk', time: '1 hr ago', sentiment: 'positive', category: 'crypto', tags: ['BTC', 'COIN', 'MSTR'] },
    { headline: 'Bank of Thailand Holds Interest Rate Steady at 2.25%', source: 'Krungthep Turakij', time: '2 hrs ago', sentiment: 'neutral', category: 'thailand', tags: ['KBANK', 'SCB', 'BBL'] },
    { headline: 'Tesla Deliveries Miss Q1 Estimates, Shares Fall 2%', source: 'Bloomberg', time: '2 hrs ago', sentiment: 'negative', category: 'usa', tags: ['TSLA', 'RIVN', 'F'] },
    { headline: 'Thai Baht Strengthens Against USD on Trade Surplus Data', source: 'SET News', time: '3 hrs ago', sentiment: 'positive', category: 'economy', tags: ['THB', 'SET'] },
    { headline: 'Apple Expected to Launch AI-Powered iPhone 17 in September', source: 'Reuters', time: '3 hrs ago', sentiment: 'positive', category: 'usa', tags: ['AAPL', 'QCOM', 'TSM'] },
    { headline: 'Ethereum 2.0 Staking Yields Attract Record Capital Inflows', source: 'CoinDesk', time: '4 hrs ago', sentiment: 'positive', category: 'crypto', tags: ['ETH', 'LDO'] },
    { headline: 'Global Oil Prices Drop 3% on OPEC+ Production Increase Plans', source: 'Bloomberg', time: '4 hrs ago', sentiment: 'negative', category: 'economy', tags: ['PTT', 'XOM', 'CVX'] },
    { headline: 'CP ALL Reports Strong Q4 Earnings, Beats Analyst Estimates', source: 'SET News', time: '5 hrs ago', sentiment: 'positive', category: 'thailand', tags: ['CPALL', 'MAKRO'] },
    { headline: 'Meta AI Assistant Reaches 1 Billion Users Milestone', source: 'CNBC', time: '6 hrs ago', sentiment: 'positive', category: 'usa', tags: ['META', 'GOOGL', 'MSFT'] },
];
...
function renderMainChart() {
    ...
    // Create a wrapper div for TradingView
    const widgetDiv = document.createElement('div');
    widgetDiv.id = 'tv-widget-container';
    ...
    try {
        if (typeof TradingView !== 'undefined') {
            tradingViewWidget = new TradingView.widget({
                ...
                autosize: true,
                symbol: data.mainSymbol,
                interval: 'D',
                timezone: currentMarket === 'TH' ? 'Asia/Bangkok' : 'America/New_York',
                theme: 'dark',
                style: '1',
                locale: 'en',
                toolbar_bg: '#111827',
        ...
        <div style="display:flex;align-items:center;justify-content:center;height:100%;flex-direction:column;gap:1rem;color:#64748b;">
          ...
          <div style="font-size:0.9rem;font-weight:600;">TradingView Chart — ${data.mainSymbol}</div>
          <div style="font-size:0.75rem;">Loading TradingView widget...</div>
        </div>
      `;
        }
    } catch (e) {
      ...
      <div style="display:flex;align-items:center;justify-content:center;height:100%;flex-direction:column;gap:1rem;color:#64748b;">
        <div style="font-size:3rem;">📊</div>
        <div style="font-size:0.9rem;font-weight:600;">TradingView Chart — ${data.mainSymbol}</div>
        <div style="font-size:0.75rem;">Widget loading...</div>
      </div>
    `;
    }
}
...
function renderNewsTab() {
    ...
    <div class="glass-card news-card">
      ...
      <div class="news-headline"><a href="#">${n.headline}</a></div>
...
function openChartModal(symbol, exchange) {
    ...
    title.textContent = `${symbol} — Full Chart`;
    body.innerHTML = '';

    const widgetDiv = document.createElement('div');
    widgetDiv.id = 'modal-tv-widget';
    widgetDiv.style.height = '100%';
    ...
    try {
        ...
        <div style="display:flex;align-items:center;justify-content:center;height:100%;flex-direction:column;gap:1rem;color:#64748b;">
          <div style="font-size:3rem;">📊</div>
          <div style="font-size:1rem;font-weight:700;">${fullSymbol}</div>
          <div style="font-size:0.8rem;">TradingView chart will load here</div>
        </div>
      `;
        }
    } catch (e) {
        widgetDiv.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;height:100%;color:#64748b;">Chart loading...</div>`;
    }
